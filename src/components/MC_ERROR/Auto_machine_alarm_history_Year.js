  ...
  componentDidMount = async () => {
    ...
    if (state && state.lineName) {
      ...
      this.setState({ Line: lineName }, () => {
        ...
        const url =
          server.MC_ERROR_percen_year_URL +
          "/" +
          this.state.Line +
          "/" +
...
const year = this.state.startDate.split('-')[0]
    ...
    await this.setState({
      ...
      options: {
        ...
        title: {
          text: `M/C error monitoring Line:${this.state.Line} Year: ${year}`,
          align: "center",
        },
        xaxis: {
          categories: xAxis,
  ...
  render() {
    ...
    return (
      <div className="content-wrapper">
        ...
        {this.state.show_link == "ok" && (   <a href="/percen_OEE_monthly">
                <i className="fa fa-arrow-left"></i> Back to OEE Monthly Dashboard Monitoring
              </a>)}
