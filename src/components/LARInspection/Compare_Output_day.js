...
max:30,
      ...
      let options = {
        ...
        title: {
          text: `%NG Daily's Summary Line ${this.state.year} Month  ${this.state.startDate}`,
          align: "center",
          offsetX: 0,
        },
        xaxis: {
  ...
  render() {
    ...
    console.log(this.state.backtofrom);
      ...
      <div className="content-wrapper">
        ...
        <div className="col-12">
          <div style={{ paddingTop: 20 }}>
            {this.state.show_link !== null && this.state.backtofrom == null && (
              <a href="/percen_OEE">
