  ...
  componentDidMount = async () => {
    ...
    if (to_link !== null) {
      this.setState(
        {
          year: lineFromState,
          startDate: startDateParam.substring(0, 4),
        },
        () => {
          const url =
          ...
          // ทำการส่งคำร้องข้อมูลไปยังเซิร์ฟเวอร์
          // ตัวอย่างนี้เป็นการเรียกใช้งานฟังก์ชัน doGetDataReport() เพื่อทำการร้องขอข้อมูล
