...
class Importment_dowtime_line extends Component {
  ...
  componentDidMount = async () => {
    ...
    // if (queryParamData) {
    //   const values = queryParamData.split("?").map((value) => value.trim());
    //   const Process_data = values[1].split("=").map((value) => value.trim());
    //   const startdate = values[2].split("=").map((value) => value.trim());
    //   const finishdata = values[3].split("=").map((value) => value.trim());

    //   this.setState(
    //     {
    //       getline_pagline: values[0],
    //       getprocess_pagline: Process_data[1],
    //       getstart_pagline: startdate[1], // Assuming 'startdate' is on the right side of the '='
    //       getfinish_pagline: finishdata[1], // Assuming 'finishdata' is on the right side of the '='
    //     },
    //     () => {
    //       // Use the updated state values here in the callback function
    //       this.state.line.label = this.state.getline_pagline;
  ...
  doGetDataReport = async () => {
    ...
    let Equipment1 = result.data.Equipment;
    ...
    let Equipment = result_Second.data.Equipment;
    ...
    await this.setState({
        ...
        data: [
          {
            ...
            click: function (e) {
              ...
              console.log(label2);
              window.location.href = `/Importment_downtime_case_detail?data=${label}&process=${label2}&startDate=${lb_startDate}&finishDate=${lb_finishDate}&Line=${lb_line}`
            },
          },
        ],
      ...
      options2: {
        ...
        title: {
          text: "Downtime frequency each machine",
          // this.state.startDate +
          // " To " +
          // this.state.finishDate +
          // "   -  Process : " +
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1>Importment downtime machine</h1>
                  {/* <FcComboChart /> */}
                ...
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    ...
                    <a href="/Importment_downtime_line">Importment downtime</a>
                    </li>
                  </ol>
                </div>
              </div>
