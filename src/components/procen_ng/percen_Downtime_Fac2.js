  ...
  doGetDataReport = async () => {
    try {
      const result = await httpClient.get(
        server.percen_Downtime_URL + "_Fec2/" + this.state.startDate + "/Fac2"
      );
      console.log(result);
  ...
  render() {
    ...
    const Second_perPcs =
      this.state.rawData_2.length > 0
        ...
        : 0;
        const totalDTL=
        this.state.rawData_2.length > 0 ? this.state.rawData_2[0].Total_DL : 0;
    return (
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="row" style={{ marginBottom: "5px" }}>
                  <h1>
                    Downtime Dashboard Monitoring FAC2{" "}
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        ...
                        (item) => item.Line.substring(item.Line.indexOf('-') + 1) === "A"
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        ...
                        (item) =>  item.Line.substring(item.Line.indexOf('-') + 1)  === "B"
                      ) // Filter items for ZONE 1
                        .map((item, index) => {
                          // Extract the substring from the Line property
                          const lineSubstring = item.Line.substring(0, 5); // Adjust the index as needed
