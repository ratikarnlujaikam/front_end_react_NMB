                          ...
                          return (
                            <div key={index} className="col-md-1">
                              <button
                                className="btn btn-warning text-center"
                                style={{
                                  backgroundColor: item.NG === null ? "#555555" : item.NG < 85 ? "red" : "green",
                                  color: "white",
                                  padding: "10px",
                                  margin: "8px",
                                        ...
                                        <div>
                                          <div>
                                            <span style="color: black; font-weight: bold; text-align: center;">
                                              PF ${item.PE_Percentage != null ? parseFloat(item.PE_Percentage).toFixed(2) + ' %' : 'N/A'}
                                            </span><br>
                                            <a href="/Compare_Output_Day?&line=${encodeURIComponent(item.Line)}&startDate=${encodeURIComponent(this.state.startDate)}&to_link=${encodeURIComponent("ok")}">
                                            ...
                                            <a href="/mc_percen_error?&line=${encodeURIComponent(item.Line)}&startDate=${encodeURIComponent(this.state.startDate)}&to_link=${encodeURIComponent("ok")}">
                                              <span style="color: blue; font-weight: bold;">
