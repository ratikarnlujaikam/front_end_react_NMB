  ...
  doGetDataReport = async () => {
    try {
      const result = await httpClient.get(
        server.percen_Downtime_URL + "_WR/" + this.state.startDate + "/White room"
      );
      console.log(result);
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="row" style={{ marginBottom: "5px" }}>
                  <h1>
                    Downtime Dashboard Monitoring White room{" "}
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        (item) => item.Line.substring(0, 1) === "A"
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        ...
                        (item) => item.Line.substring(0, 1) === "B"
                      ) // Filter items for ZONE 1
                        .map((item, index) => {
                          // Extract the substring from the Line property
                          const lineSubstring = item.Line.substring(0, 5); // Adjust the index as needed
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        (item) => item.Line.substring(0, 1) === "C"
                      ) // Filter items for ZONE 1
                        .map((item, index) => {
                          // Extract the substring from the Line property
                          const lineSubstring = item.Line.substring(0, 5); // Adjust the index as needed
