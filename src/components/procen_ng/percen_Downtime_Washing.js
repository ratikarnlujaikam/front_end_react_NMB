  ...
  doGetDataReport = async () => {
    try {
      const result = await httpClient.get(
        server.percen_Downtime_URL + "_Washing/" + this.state.startDate + "/Washing"
      );
      console.log(result);
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="row" style={{ marginBottom: "5px" }}>
                  <h1>
                    Downtime Dashboard Monitoring Washing{" "}
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        ...
                        (item) => item.Line.includes("DAN")
                      ) // Filter items for ZONE 1
                        .map((item, index) => {
                          // Extract the substring from the Line property
                          const lineSubstring = item.Line.substring(8, item.Line.length); // Adjust the index as needed
                            ...
                            <div key={index} className="col-sm-1">
                              <button
                                ...
                                style={{
                                  ...
                                  padding: "20px",
                                  margin: "8px",
                                  width: "130px", // Set a fixed width for the button
                                }}
                                onClick={() => {
                    ...
                    <div className="row">
                      ...
                      {this.state.Raw_Dat.filter(
                        ...
                        (item) =>  item.Line.includes("Shinsiri") 
                      ) // Filter items for ZONE 1
                        .map((item, index) => {
                          // Extract the substring from the Line property
                          const lineSubstring = item.Line.substring(8, item.Line.length); // Adjust the index as needed
